#!/usr/bin/env python3
"""
Title: Interactive S&P 500 Sector Seasonality App (No CSV)
Description:
  ...
  - Avoid special chars in filename (no &).
"""
...
def fetch_price_data(tickers, start_date, end_date):
    ...
    for ticker in tickers:
        try:
            ...
            print(f"[WARN] Problem fetching {ticker}: {e}")
            pass
...
class SectorSeasonalityApp(pn.viewable.Viewer):
    ...
    def _run_analysis(self, event):
        ...
        # Build the “Which sector to invest each month” chart
        bars = []
...
# If run as script with `panel serve SP500Cycle.py`, show `app.panel_view()`
pn.extension()
